...
keymongodb = process.env.mongodb 'mongodb+srv://hendraxd:UpB3gAOvubXajz7G@cluster0.ds5fuj7.mongodb.net/?retryWrites=true&w=majority';
...
sendemail = process.env.sendemail 'hgindonesia3@gmail.com' //Email SMTP
fromsendemail = process.env.fromsendemail 'hgindonesia3@gmail.com' // From Email SMTP *kalau takde custom email kena sama email dengan Email SMTP
sendpwmail = process.env.sendpwmail 'ufbdqtihvtitilqa' // Password Email SMTP
domain = 'hendraxdbotz.vercel.app' // domain website tanpa http or https
...
recaptcha_key_1 = process.env.recaptcha_key_1 '6Lew1iUnAAAAAHa218cBgq1VYtFwVR-77_iek7hb'
recaptcha_key_2 = process.env.recaptcha_key_2 '6Lew1iUnAAAAACje3O4xtH0JUTpSGZLBrF24FVoc'
